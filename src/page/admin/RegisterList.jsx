          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <div className="w-full md:w-1/2">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Registratorlar ismi, telefon qidirish..."
            ...
            <div className="flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-lg">
              ...
              <span className="text-blue-900 font-medium">
                Jami registratorlar: <span className="text-blue-600">{employers.length}</span>
              </span>
            </div>
          </div>
              ...
              <table className="min-w-full">
                <thead>
                  <tr className="bg-blue-600 text-white">
                    ...
                    <th className="py-3 px-4 text-left hidden md:table-cell">Login</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredEmployers.length === 0 ? (
                    ...
                    filteredEmployers.map((emp) => (
                      ...
                      >
                        ...
                        <td className="py-4 px-4 hidden md:table-cell">{emp.login || '-'}</td>
                      </tr>
                    ))
                  )}
                </tbody>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="bg-gray-50 rounded-xl p-5">
                  <h3 className="text-lg font-semibold text-gray-800 mb-3">Login parol</h3>
