...
import { FaUserGraduate, FaEye, FaMoneyBillWave, FaTimes } from 'react-icons/fa'
              ...
              {isLoading ? (
                ...
                <>
                            ...
                            >
                              ...
                              <td className="py-3 px-4">
                                <button 
                                  ...
                                  className={`flex items-center py-1 px-3 rounded-lg transition-all ${
                                    monthData.balance === 0 
                  ...
                  <button
                    ...
                    className={`w-full py-3 rounded-xl text-white font-bold transition-all flex items-center justify-center mt-6 ${
